...
#adam++        board='PEPPY')
  ...
  def GetDeviceInfo(self, mlb_sn):
    ...
    if ret['sku_number'][8:] == 'ABU':
        ret['region'] = re.sub('ABU', 'gb', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABA':
        ret['region'] = re.sub('ABA', 'us', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABF':
        ret['region'] = re.sub('ABF', 'fr', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABD':
        ret['region'] = re.sub('ABD', 'de', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABL':
        ret['region'] = re.sub('ABL', 'ca.hybrid', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABG':
        ret['region'] = re.sub('ABG', 'au', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ABH':
        ret['region'] = re.sub('ABH', 'nl', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'UUW':
        ret['region'] = re.sub('UUW', 'nordic', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'AB4':
        ret['region'] = re.sub('AB4', 'sg', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ACJ':
        ret['region'] = re.sub('ACJ', 'in', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'UUF':
        ret['region'] = re.sub('UUF', 'my', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'ACB':
        ret['region'] = re.sub('ACB', 'ru', ret['sku_number'])[8:]
    if ret['sku_number'][8:] == 'UUZ':
        ret['region'] = re.sub('UUZ', 'ch', ret['sku_number'])[8:]

    ret['keyboard'] = re.sub('ABU', 'gb', ret['keyboard'])
    ret['keyboard'] = re.sub('ABA', 'us', ret['keyboard'])
    ret['keyboard'] = re.sub('ABF', 'fr', ret['keyboard'])
    ret['keyboard'] = re.sub('ABD', 'de', ret['keyboard'])
    ret['keyboard'] = re.sub('ABL', 'ca.hybrid', ret['keyboard'])
    ret['keyboard'] = re.sub('ABG', 'au', ret['keyboard'])
    ret['keyboard'] = re.sub('ABH', 'nl', ret['keyboard'])
    ret['keyboard'] = re.sub('UUW', 'nordic', ret['keyboard'])
    ret['keyboard'] = re.sub('AB4', 'sg', ret['keyboard'])
    ret['keyboard'] = re.sub('ACJ', 'in', ret['keyboard'])
    ret['keyboard'] = re.sub('UUF', 'my', ret['keyboard'])
    ret['keyboard'] = re.sub('ACB', 'ru', ret['keyboard'])
    ret['keyboard'] = re.sub('UUZ', 'ch', ret['keyboard'])
