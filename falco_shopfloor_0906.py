...
class RequestTypes(object):
  ...
  FA_START_FAT = RequestType(
      ...
      # By Bestry 'nft/Request', 'nft/Response','' , 'STATION=FAT')
  HWID_COMPLETE = RequestType(
      'CQ_Monitor/Handshake', 'CQ_Monitor/HandShakeResp', '', None)
  FA_END = RequestType(
      'CQ_Monitor2/Handshak', 'CQ_Monitor2/HandResp', '', None)
...
#adam++        board='PEPPY')
  ...
  def GetDeviceInfo(self, mlb_sn):
    ...
    ret['region'] = re.sub('ABL', 'gb', ret['region'])#By Bestry
...
# 		cellular = 'Y'
  ...
  def FinishFA(self, mlb_sn, device_data):
